...
`execution_log.txt` is the console's exported plain-text recording. `remediation_report.json` is the sorted, indented serialization of the exact `IncidentReport` returned by that same execution.
